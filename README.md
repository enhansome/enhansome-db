...
* [rocksdb](https://github.com/facebook/rocksdb) ⭐ 32,030 | 🐛 1,631 | 🌐 C++ | 📅 2026-08-28 - Embedded key-value store for fast storage <http://rocksdb.org>
* [mongo](https://github.com/mongodb/mongo) ⭐ 28,521 | 🐛 32 | 🌐 C++ | 📅 2026-08-29 - The Mongo Database <http://www.mongodb.org/>
...
* [postgres](https://github.com/postgres/postgres) ⭐ 21,944 | 🐛 0 | 🌐 C | 📅 2026-08-30
* [memcache](https://github.com/memcached/memcached) ⭐ 14,263 | 🐛 103 | 🌐 C | 📅 2026-07-10 - Free & open source, high-performance, distributed memory object caching system
...
* [RavenDB](https://github.com/ravendb/ravendb) ⭐ 3,995 | 🐛 75 | 🌐 C# | 📅 2026-08-28 - A linq enabled document database for .NET <http://ayende.com/Blog/>
...
* [elasticsearch](https://github.com/elasticsearch/elasticsearch) ⭐ 77,882 | 🐛 6,016 | 🌐 Java | 📅 2026-08-30 - Open Source, Distributed, RESTful Search Engine [website](http://elasticsearch.org)
* [neo4j](https://github.com/neo4j/neo4j) ⭐ 17,165 | 🐛 255 | 🌐 Java | 📅 2026-08-24 - [Neo4j](http://neo4j.org) is the world’s leading Graph Database.
* [cassandra](https://github.com/apache/cassandra) ⭐ 10,089 | 🐛 476 | 🌐 Java | 📅 2026-08-29 - Cassandra is a partitioned row store. Rows are organized into tables with a required primary key.
...
* [orientdb](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 356 | 🌐 Java | 📅 2026-08-26 - OrientDB is an Open Source NoSQL DBMS with the features of both Document and Graph DBMSs.
