...
* [rocksdb](https://github.com/facebook/rocksdb) ⭐ 32,008 | 🐛 1,622 | 🌐 C++ | 📅 2026-08-22 - Embedded key-value store for fast storage <http://rocksdb.org>
* [mongo](https://github.com/mongodb/mongo) ⭐ 28,501 | 🐛 31 | 🌐 C++ | 📅 2026-08-25 - The Mongo Database <http://www.mongodb.org/>
...
* [RavenDB](https://github.com/ravendb/ravendb) ⭐ 3,992 | 🐛 72 | 🌐 C# | 📅 2026-08-24 - A linq enabled document database for .NET <http://ayende.com/Blog/>
...
* [elasticsearch](https://github.com/elasticsearch/elasticsearch) ⭐ 77,860 | 🐛 5,935 | 🌐 Java | 📅 2026-08-25 - Open Source, Distributed, RESTful Search Engine [website](http://elasticsearch.org)
* [neo4j](https://github.com/neo4j/neo4j) ⭐ 17,128 | 🐛 241 | 🌐 Java | 📅 2026-08-24 - [Neo4j](http://neo4j.org) is the world’s leading Graph Database.
* [cassandra](https://github.com/apache/cassandra) ⭐ 10,080 | 🐛 472 | 🌐 Java | 📅 2026-08-24 - Cassandra is a partitioned row store. Rows are organized into tables with a required primary key.
...
* [orientdb](https://github.com/orientechnologies/orientdb) ⭐ 4,981 | 🐛 356 | 🌐 Java | 📅 2026-08-24 - OrientDB is an Open Source NoSQL DBMS with the features of both Document and Graph DBMSs.
...
* [couchdb](https://github.com/apache/couchdb) ⭐ 6,941 | 🐛 368 | 🌐 Erlang | 📅 2026-08-25 - Apache CouchDB™ is a database that uses JSON for documents,JavaScript for MapReduce indexes, and regular HTTP for its API \[website] (<http://couchdb.apache.org/>)
